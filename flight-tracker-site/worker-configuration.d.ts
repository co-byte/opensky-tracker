/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3ef12fe7b2aa7da44d9c2340f4c92b96)
// Runtime types generated with workerd@1.20260917.1 2026-09-16 
interface __BaseEnv_Env {
	DATABRICKS_ACCOUNT_ID: string;
	DATABRICKS_DEPLOYMENT_NAME: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABRICKS_ACCOUNT_ID" | "DATABRICKS_DEPLOYMENT_NAME" | "DATABRICKS_WAREHOUSE_ID" | "DATABRICKS_CLIENT_ID" | "DATABRICKS_CLIENT_SECRET">> {}
}
